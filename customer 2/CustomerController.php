...
class CustomerController extends Controller
{
    ...
    {   
        ...
        $kota = Kotum::where("ID_PROVINSI",$id_provinsi)->pluck('NAMA_KOTA','ID_KOTA');
    ...
    public function store2(Request $request)
    {
        ...
        // $this->validate($request, ['foto'=>'required|file|max:100']);
        // $path       =   Storage::putFileAs('public/images', $request->file('foto'), $imgname);
        // Customer::create(['FILE_PATH'=>$imgname]); 
        // return redirect('/Customer/DataCustomer', $path);
